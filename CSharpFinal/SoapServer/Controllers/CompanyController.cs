...
namespace SoapServer.Controllers
{
    public class CompanyController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="Id,Name,AddressID,PhoneNumber")] Company company)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="Id,Name,AddressID,PhoneNumber")] Company company)
        {
            if (ModelState.IsValid)
            {
